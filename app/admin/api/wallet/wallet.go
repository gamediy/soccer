...
type GetReq struct {
	g.Meta `tags:"/ordersvc" method:"get" path:"/" dc:"查询钱包信息"`
	Uid    uint64 `v:"required"`
}
type GetRes entity.Wallet
type UpdateBalanceReq struct {
	g.Meta      `tags:"/ordersvc" method:"put" path:"/update" dc:"修改用户钱包"`
...
type FreezeReq struct {
	g.Meta      `tags:"/ordersvc" method:"put" path:"/freeze" dc:"冻结用户余额"`
	Uid         uint64 `json:"uid" v:"required"`
